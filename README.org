...
#+begin_export html
<a href="./01 - introduction.pdf">Version PDF</a>
#+end_export
...
package dti.g25.pendu {
	...
	class Jeu {
		...
		+ estRéussi(): Boolean
		+ réinitialiser()
		+ étatDesLettresDécouvertes(): Array<Char>
	}

	class MainActivity {
        - jeu: Jeu						
		- onClick(v : View)
		- rafraîchirLettres( état: String )
		- rafraîchirScore( score: Int)
...
** La classe ~Jeu~ qui simule le jeu. Elle doit comporter les membres
   suivants :
   ...
   - La méthode ~étatDesLettresDécouvertes~, qui retourne un tableau de caractères représentant chacun une lettre du mot à deviner par :
